...
NOTE: Agent 1 owns this file after merge. The stub here replicates the spec
exactly so Agent 3 can develop the API layer without Agent 1's code.
"""
...
# ─── Shared constants (must match CLAUDE.md) ─────────────────────────────────
...
class MetricsSnapshot:
    ...
    doctor_utilisation_pct: float           # % of doctor capacity slots in use
